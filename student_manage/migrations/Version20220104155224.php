 ...
 */
final class Version20220104155224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, duration VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, student_class_id INT DEFAULT NULL, picture VARCHAR(255) NOT NULL, code VARCHAR(10) NOT NULL, name VARCHAR(30) NOT NULL, age INT NOT NULL, gender VARCHAR(255) NOT NULL, INDEX IDX_B723AF33598B478B (student_class_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teacher (id INT AUTO_INCREMENT NOT NULL, student_class_id INT DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, code VARCHAR(10) NOT NULL, name VARCHAR(30) NOT NULL, age VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, INDEX IDX_B0F6A6D5598B478B (student_class_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
