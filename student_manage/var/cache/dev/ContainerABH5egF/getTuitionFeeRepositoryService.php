 ...
 */
class getTuitionFeeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TuitionFeeRepository' shared autowired service.
     *
     * @return \App\Repository\TuitionFeeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TuitionFeeRepository.php';

        return $container->privates['App\\Repository\\TuitionFeeRepository'] = new \App\Repository\TuitionFeeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
