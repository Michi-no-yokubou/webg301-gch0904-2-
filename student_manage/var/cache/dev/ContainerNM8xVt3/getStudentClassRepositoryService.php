 ...
 */
class getStudentClassRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StudentClassRepository' shared autowired service.
     *
     * @return \App\Repository\StudentClassRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StudentClassRepository.php';

        return $container->privates['App\\Repository\\StudentClassRepository'] = new \App\Repository\StudentClassRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
